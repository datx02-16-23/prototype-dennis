...
import com.dennisjonsson.annotation.processor.parser.NodeVisitor;
...
public class SourceProcessor{
    ...
    public SourceProcessor(CharSequence sequence, String className, 
            Element packageElement, String path, CompilationUnit compilationUnit){

            this.source = sequence.toString();
            this.className = className;
            this.dataStructures = new ArrayList<DataStructure>();
    ...
    public void insertLogger(){
        insertField("public static com.dennisjonsson.log.Logger logger = \n"
                +   "new com.dennisjonsson.log.Logger(\n"
                +   printDataStructures()
                +   ");");
    }
    ...
    */
    ...
    public void interceptionCalls(){
        for(DataStructure dataStruct : dataStructures){
            NodeVisitor visitor = new NodeVisitor(dataStructures);
            visitor.visit(compilationUnit, dataStruct.getIdentifier());
            
        }
    }

    public void insertInterceptionCalls(){
    ...
    */
    ...
    public void insertInterceptorMethods(){
